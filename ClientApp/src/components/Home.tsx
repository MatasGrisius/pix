                ...
                <div className="card-body">
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    <div className="btn-group">
                      <button onClick={() => this.props.history.push('/photo/' + e.id)} type="button" className="btn btn-sm btn-outline-secondary">View</button>
                      <button onClick={() => this.props.history.push('/editphoto/' + e.id)} type="button" className="btn btn-sm btn-outline-secondary">Edit</button>
